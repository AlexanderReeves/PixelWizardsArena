...
#id 0 for anything else that won't animate here
#id 1 = practise_wand, Uses 1 charge
#id 2 = practise_staff
scoreboard players set @e[scores={botatkcooldown=0},hasitem={item=wizard:pull_trap,location=slot.weapon.mainhand}] initialweapon 0
