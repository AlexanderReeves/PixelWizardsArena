...
#tp players to arena
tp @a -148.53 207.00 349.40 180 0
...
#Start Messages
 tellraw @a {"rawtext":[{"text":"§fWizard Wally: §dAh, good to be back here again. I remember winning my first tournament here. Before you start, I recommend refreshing your wizarding knowledge via the tutorial. "}]}