...
execute at @a run execute as @e[type=armor_stand,r=3,tag=tutorial] run function battle/palace/starttutorial
...
#start the battle waves if the battle is triggeres
execute at @a run execute as @e[type=armor_stand,r=3,tag=start] run function battle/palace/startbattle
