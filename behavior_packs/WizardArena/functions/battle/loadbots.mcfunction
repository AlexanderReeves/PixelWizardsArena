...
execute as @e[type=space:variables,scores={activeplayers=1..,destinationint=2}] run summon wizard:wizard  -148.40 207.00 365.65 90 0
...
scoreboard players set @e[type=wizard:wizard] trapcooldown 0

#Summon NPC Guide
kill @e[type=wizard:npc_guide]
summon wizard:npc_guide -148.59 207.20 357.37 270 0
replaceitem entity @e[type=wizard:npc_guide] slot.weapon.mainhand 1 wizard:practise_staff
