...
#scoreboard for trap releases
scoreboard objectives remove trapcooldown
scoreboard objectives add trapcooldown dummy trapcooldown
...
#Objective to be used to track the players current trap
scoreboard objectives remove trapid
scoreboard objectives add trapid dummy trapid

#objective to track how many traps a player is holding, 4 max
scoreboard objectives remove trapamount
scoreboard objectives add trapamount dummy trapamount

#scoreboard for generating random numbers
scoreboard objectives remove rng
scoreboard objectives add rng dummy rng

#scoreboard for battle wave
